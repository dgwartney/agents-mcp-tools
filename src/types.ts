...
type FlowTraceEventType = 'flow_step_enter' | 'flow_step_exit' | 'flow_transition';
...
type MemoryTraceEventType = 'memory_recall' | 'memory_recall_result';
...
export type ClientMessage =
  | { type: 'load_agent'; agentPath: string }
